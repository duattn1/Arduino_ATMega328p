/** @file timer_hal.h
 *  @brief Declaration of Timer driver function and data.
 *
...
/**
 * @enum This enumeration is a list of available Timer channels.
 */
typedef enum
{
...
/**
 * @enum This enumeration is a list of Timer compare output mode.
 */
typedef enum
{
 ...
 */
typedef struct {
    Enum_Timer_TCCRnA_CompareMatchOutputMode_Typedef compareOutputMode_enum;        /**< Compare output mode */
    Enum_Timer_TCCRnA_WaveformGenerationMode_Typedef waveformGenerationMode_enum;   /**< Waveform generation mode */
    Enum_Timer_TCCRnB_ClockSelect_Typedef clockPrescaler_enum;                      /**< Clock prescaler selection */
    uint8_t compareOutputValue_uint8;                                               /**< Compare output register value */
 ...
 */
typedef struct {
    Enum_Timer_TCCRnB_ClockSelect_Typedef prescalerName_enum;   /**< Prescaler enumeration constant */
    uint16_t prescalerValue_uint16;                             /**< Prescaler integer value */
